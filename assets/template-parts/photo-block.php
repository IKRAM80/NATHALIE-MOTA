...
<div class="photo-suggested" data-photo-src="<?php echo get_the_post_thumbnail_url(); ?>" 
                             ...
                             data-photo-ref="<?php echo esc_attr(get_field('référence')); ?>"
                             data-photo-category="<?php echo esc_attr(get_the_terms(get_the_ID(), 'catégories')[0]->name); ?>">
     ...
     <div class="overlay">
          <div class="overlay__full">
            ...
            <p class="overlay-category overlay-text"><?php echo get_the_terms(get_the_ID(), 'catégories')[0]->name; ?></p>                                
          </div>
     </div>
